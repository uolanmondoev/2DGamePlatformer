...
screen_height = (tile_size * (cols - 8)) + margin
...
zombie_img = pygame.image.load('img/zombie.png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 3:
					#enemy blocks
					img = pygame.transform.scale(zombie_img, (tile_size, int(tile_size * 0.75)))
...
save_button = Button(screen_width // 2 - 150, screen_height - 80, pygame.transform.scale(save_img, (2 * tile_size, tile_size)))
load_button = Button(screen_width // 2 + 50, screen_height - 80, pygame.transform.scale(load_img, (2 * tile_size, tile_size)))
...
while run:
	...
	#screen.blit(moon_img, (tile_size * 2, tile_size * 2))
